      ...
      <div ref={containerRef} style={{ padding: '0 1.5rem 1.5rem' }}>
        <ResponsiveContainer width={width} height={220}>
          <AreaChart data={monthlyData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <ReferenceLine y={20} stroke={T.green} strokeDasharray="6 3" strokeWidth={1.5} label={{ value: t('trends.chartSRGoal'), fill: T.green, fontSize: 11 }} />
            <ReferenceLine y={0} stroke={T.red} strokeDasharray="3 3" strokeWidth={1} />
            <Area type="monotone" dataKey="savingsRate" name={t('trends.chartSRSeries')} stroke={T.accent} strokeWidth={2.5} fill="url(#savingsGradient)" dot={{ fill: T.accent, r: 4 }} activeDot={{ r: 6 }} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </Card>
