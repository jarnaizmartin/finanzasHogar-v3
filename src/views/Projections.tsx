                          ...
                          <div
                            style={{
                              ...
                              background:
                                proj.type === 'income'
                                  ? T.green
                                  : proj.type === 'transfer' && !proj.linkedLoanId
                                  ? T.accent
                                  : T.red,
                              flexShrink: 0,
                            }}
                      ...
                      {isExpanded && (
                        ...
                        >
                          {[
                            ...
                            // Para transfers (incluidas cuotas de préstamo)
                            // mostramos origen + destino. Para income/expense,
                            // mostramos cuenta + categoría.
                            ...(proj.type === 'transfer'
                              ? [
                                  { label: 'Desde', value: acc?.name ?? '—' },
                                  {
                                    label: proj.linkedLoanId
                                      ? 'Préstamo destino'
                                      : 'Hasta',
